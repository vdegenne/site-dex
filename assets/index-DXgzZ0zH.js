import{Q as b,l as m,w as f,E as p,q as k,D as y}from"./index-Bhfyq8ur.js";import{s as d}from"./item-dialog-CpQSEU4n.js";function P({headline:i,content:o,cancelButton:t,confirmButton:a,blockScrimClick:w=!1,blockEscapeKey:g=!1,onDialogReady:c,styles:v}){return new Promise(async(h,A)=>{const s=document.createElement("div");let u=Promise.resolve(),$=Promise.resolve(),n=!1;b(m`
				<md-dialog
					?block-scrim-click="${w}"
					?block-escape-key="${g}"
					style="${d(v??{})}"
